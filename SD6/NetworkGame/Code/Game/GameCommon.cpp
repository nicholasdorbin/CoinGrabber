...
bool g_DisplayMemoryDebug = false;
bool g_DisplaySessionDebug = false;
NetTypesSystem* g_netTypesSystem = nullptr;
...
void InitializeCommon()
{
	...
	g_netTypesSystem = new NetTypesSystem();
	g_netTypesSystem->RegisterAllNetObjectTypes();
}

void DestroyCommon()
{
	//delete g_Atlas;
	delete g_netTypesSystem;
}
